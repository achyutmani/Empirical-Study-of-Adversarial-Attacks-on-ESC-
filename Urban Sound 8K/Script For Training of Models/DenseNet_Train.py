...
EPOCHS =150   # Define maximum Number of Epochs
FC_Size=512
SFC_Size=512
Temp=3
alpha=0.7
...
class Teacher(nn.Module): # Subband-1 Network using Pre-Trained Resent-34
    def __init__(self):
        ...
        Pre_Trained_Layers=nn.Sequential(*list(models.densenet161(pretrained=True).children())[:-1])
...
def evaluate(model,device,iterator, criterion): # Evaluate Validation accuracy 
    ...
    return epoch_loss / len(iterator), epoch_acc / len(iterator) 
MODEL_SAVE_PATH = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'DenseNet_CNN.pt') # Define Path to save the model 
...
np.save('/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Model Parameters/DenseNet_CNN_Parameters',Temp) # Save Temp Array as numpy array 
