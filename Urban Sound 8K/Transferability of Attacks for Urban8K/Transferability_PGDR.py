...
class M1(nn.Module): # Subband-1 Network using Pre-Trained Resent-34
    def __init__(self):
        super(M1, self).__init__()
        Pre_Trained_Layers=nn.Sequential(*list(models.alexnet(pretrained=False).children())[:-1])
        self.features=Pre_Trained_Layers
        #print(self.features)
        self.features[0][0]=nn.Conv2d(1, 64, kernel_size=(11, 11), stride=(4, 4), padding=(2, 2), bias=False)
...
class M2(nn.Module): # Subband-1 Network using Pre-Trained Resent-34
    def __init__(self):
        super(M2, self).__init__()
        Pre_Trained_Layers=nn.Sequential(*list(models.vgg16(pretrained=False).children())[:-1])
        self.features=Pre_Trained_Layers
        #print(self.features)
    ...
    def forward(self,image):
        ...
        x4=self.fc3(x3)
        return x4
class M3(nn.Module): # Subband-1 Network using Pre-Trained Resent-34
    def __init__(self):
        super(M3, self).__init__()
        Pre_Trained_Layers=nn.Sequential(*list(models.densenet161(pretrained=False).children())[:-1])
        self.features=Pre_Trained_Layers
        #print(self.features)
        self.features[0][0]=nn.Conv2d(1, 96, kernel_size=(7,7), stride=(2, 2), padding=(3, 3), bias=False)
        #print(self.features)
        self.fc1=nn.Linear(108192,10)
    def forward(self,image):
        x1 = self.features(image)
        x1=x1.view(x1.shape[0],-1)
        #print(x1.shape)
        x2=self.fc1(x1)
        return x2         
class M4(nn.Module): # Subband-1 Network using Pre-Trained Resent-34
    def __init__(self):
        super(M4, self).__init__()
        Pre_Trained_Layers=nn.Sequential(*list(models.resnet101(pretrained=False).children())[:-2])
        ...
        self.fc=nn.Linear(2048,10)  # Set output layer as an one output
    ...
    def forward(self,image):
        ...
        x5=self.fc(x4)
        return x5
class M5(nn.Module): # Subband-1 Network using Pre-Trained Resent-34
    def __init__(self):
        super(M5, self).__init__()
        Pre_Trained_Layers=nn.Sequential(*list(models.resnet50(pretrained=False).children())[:-2])
        #Pre_Trained_Layers = list(models.resnet34(pretrained=True).children())[:-4]
        #Pre_Trained_Layers = models.resnet34(pretrained=True) # Initialize model layers and weights
        #print(Pre_Trained_Layers)
        self.features=Pre_Trained_Layers
    ...
    def forward(self,image):
        ...
        x5=self.fc(x4)
        return x5           
class M6(nn.Module): # Subband-1 Network using Pre-Trained Resent-34
    def __init__(self):
        super(M6, self).__init__()
        Pre_Trained_Layers=nn.Sequential(*list(models.resnet34(pretrained=False).children())[:-2])
        #Pre_Trained_Layers = list(models.resnet34(pretrained=True).children())[:-4]
        #Pre_Trained_Layers = models.resnet34(pretrained=True) # Initialize model layers and weights
        #print(Pre_Trained_Layers)
        self.features=Pre_Trained_Layers
    ...
    def forward(self,image):
        ...
        x5=self.fc(x4)
        return x5
class M7(nn.Module): # Subband-1 Network using Pre-Trained Resent-34
    def __init__(self):
        super(M7, self).__init__()
        Pre_Trained_Layers=nn.Sequential(*list(models.resnet18(pretrained=False).children())[:-2])
        #Pre_Trained_Layers = list(models.resnet34(pretrained=True).children())[:-4]
        #Pre_Trained_Layers = models.resnet34(pretrained=True) # Initialize model layers and weights
        #print(Pre_Trained_Layers)
        self.features=Pre_Trained_Layers
...
Attack_Model=M7()# Call Attack Model 
Defense_Model=M6()# Call Defense Model
#Attack_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'AlexNet_CNN.pt')
#Attack_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'VGG16_CNN.pt') 
#Attack_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'DenseNet_CNN.pt')
#Attack_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'ResNet101_CNN.pt')
#Attack_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'ResNet50_CNN.pt')
#Attack_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'ResNet34_CNN.pt')
Attack_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'ResNet18_CNN.pt')
#====================================================================================================================================================
#Defense_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'AlexNet_CNN.pt')
#Defense_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'VGG16_CNN.pt')
#Defense_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'DenseNet_CNN.pt')
#Defense_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'ResNet101_CNN.pt')
#Defense_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'ResNet50_CNN.pt')
Defense_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'ResNet34_CNN.pt')
#Defense_Model_Path = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'ResNet18_CNN.pt')
Attack_Model=Attack_Model.to(device)
Defense_Model=Defense_Model.to(device)
Attack_Model.load_state_dict(torch.load(Attack_Model_Path))
Defense_Model.load_state_dict(torch.load(Defense_Model_Path))
import torchattacks
attack=torchattacks.PGD(Attack_Model,32/255,1/255,steps=7)
...
def evaluate(model,device,iterator, criterion): # Evaluate Validation accuracy 
    ...
    return epoch_loss / len(iterator), epoch_acc / len(iterator),all_preds, ADV_Dist 
...
test_loss, test_acc,Class_Dist, ADV_Dist = evaluate(Defense_Model,device, test_loader, criterion) # Compute Test Accuracy on Unseen Signals 
