...
def calculate_accuracy(fx, y): # caluate accuracy 
    ...
    return acc
import torchattacks
attack=torchattacks.PGD(Teacher_Model,32/255,1/255,steps=7)
...
MODEL_SAVE_PATH = os.path.join("/home/mani/Desktop/AK/Empirical Study of Adversarial Examples for ESC/Urban8k/Trained Models", 'ResNet101_CNN.pt')
